...
Only registered rooms are handled; the rest are ignored (allowlist).
Convention: 1:1 (SINGLE) answers everything; busy GROUP rooms only when
...
# Unregistered rooms have no handler and are silently ignored.
